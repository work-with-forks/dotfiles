...
if [[ "$INSTALL_PACKAGES" == true ]]; then
    ...
    sudo apt install suckless-tools fish subversion cmake automake npm dfu-util patool exuberant-ctags global vim xclip ncdu sshpass socat zathura dmenu python-xpyb python-pip dos2unix curl keychain
